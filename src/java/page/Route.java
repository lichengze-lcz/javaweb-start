...
//详细商品信息
    ...
    private Seller seller;//所属商家        //*提前设置好位置 用于Dao 查询出商家的信息 时 进行存放到route对象里          数据库关系一个商家卖多个商品
    private List<RouteImg> routeImgList;//用于Dao 查询出图片的信息 时 进行存放route对象里         商品详情图片列表   根据id 查询出很多的商品图片   (数据库关系一个route id 对应routeImage表多个图片)
